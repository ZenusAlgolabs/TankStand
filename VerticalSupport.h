...
// X Y axis
bool drawDiagonal(int count, int ID, int refID, int offSet, double deviation, double width, double thickness, int location, double slant)
{
	...
	if (count == 0)
	{
		...
		x_2 = x_1;             y_2 = y_1 + width;           z_2 = z_1 + width * cos(SlantAngle);
		x_3 = x_2 + thickness; y_3 = y_2;                   z_3 = z_2;
		x_4 = x_3;             y_4 = y_1 + thickness;       z_4 = z_1 + thickness * cos(SlantAngle);
	...
	else if (count == 1)
	{
		...
		x_2 = x_1;                       y_2 = y_1 + thickness;       z_2 = z_1 + thickness / cos(SlantAngle);
		x_3 = x_2 + (width - thickness); y_3 = y_2;                   z_3 = z_2;
		x_4 = x_3;                       y_4 = y_1 + width;           z_4 = z_1 + width / cos(SlantAngle);
		x_5 = x_1 + width;               y_5 = y_4;                   z_5 = z_4;
		x_6 = x_5;                       y_6 = y_1;                   z_6 = z_1;
	}
	else if (count == 2)
	{
		...
		z_2 = z_1;             y_2 = y_1 + width;           x_2 = x_1 + width / cos(SlantAngle);
		z_3 = z_2 + thickness; y_3 = y_2;                   x_3 = x_2;
		z_4 = z_3;             y_4 = y_1 + thickness;       x_4 = x_1 + thickness / cos(SlantAngle);
	...
	else if (count == 3)
	{
		...
		z_2 = z_1;                       y_2 = y_1 + thickness;       x_2 = x_1 + thickness / cos(SlantAngle);
		z_3 = z_2 + (width - thickness); y_3 = y_2;                   x_3 = x_2;
		z_4 = z_3;                       y_4 = y_1 + width;           x_4 = x_1 + width / cos(SlantAngle);
		z_5 = z_1 + width;               y_5 = y_4;                   x_5 = x_4;
		z_6 = z_5;                       y_6 = y_1;                   x_6 = x_1;
	}
	Sketch_LBeam(ID, refID, offSet);
	return true;
}

bool drawHorizontal(int count, int ID, int refID, int offSet, double deviation, double width, double thickness, int location)
{
	x_1 = 0.0; y_1 = 0.0; z_1 = 0.0;
	x_2 = 0.0; y_2 = 0.0; z_2 = 0.0;
	x_3 = 0.0; y_3 = 0.0; z_3 = 0.0;
